/**
 * Actualiza los templates de Resend con diseño premium FLOWCHART.
  ...
  <table cellpadding="0" cellspacing="0" align="center" style="margin:0 auto;">
    <tr>
      ...
      <td style="padding-left:14px;">
        <span style="font-size:24px; font-weight:800; letter-spacing:6px; color:#e2e8f0; font-family:'Segoe UI',Arial,sans-serif;">FLOWCHART</span>
      </td>
    </tr>
  </table>
  <!-- Accent line -->
...
const flowchartFooter = (note: string) => `
...
<tr><td style="padding:0 40px 40px; text-align:center;">
  ...
  <p style="color:#1e293b; font-size:10px; margin:12px 0 0; letter-spacing:2px; font-family:'Segoe UI',Arial,sans-serif;">
    FLOWCHART &#x2022; MARKETING INTELLIGENCE PLATFORM
  </p>
</td></tr>`;
...
<tr><td style="padding:48px 20px;" align="center">
  ...
  ">
    ...
    ${flowchartFooter("Este enlace expira en 1 hora por seguridad.")}
  ...
  ">
    ...
    <tr><td style="padding:32px 40px 40px;">
      ...
      <p style="color:#94a3b8; font-size:15px; line-height:1.7; margin:0 0 24px; font-family:'Segoe UI',Arial,sans-serif;">
        <strong style="color:#e2e8f0;">{{{INVITER_NAME}}}</strong> te ha invitado a unirte a un workspace en FLOWCHART.
      </p>
    ...
    ${flowchartFooter("Esta invitaci&#xF3;n expira en 7 d&#xED;as.")}
...
async function main() {
  console.log("\n  FLOWCHART — Actualizando templates de email\n");
  console.log("  ────────────────────────────────────────\n");

  await updateTemplate(PASSWORD_RESET_ID, "flowchart-password-reset", passwordResetHtml);
  await updateTemplate(WORKSPACE_INVITE_ID, "flowchart-workspace-invite", workspaceInviteHtml);
