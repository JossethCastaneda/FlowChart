  ...
  return (
    <div style={{
      ...
      <div style={{ height: 200 }}>
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={chartData.points} margin={{ top: 5, right: 10, left: 0, bottom: 0 }}>
            ...
            <XAxis
              dataKey="label"
              tick={{ fontSize: 9, fill: "rgba(148,163,184,0.4)" }}
              axisLine={{ stroke: "rgba(255,255,255,0.04)" }}
              tickLine={false}
              interval="preserveStartEnd"
            />
            <YAxis
              tick={{ fontSize: 9, fill: "rgba(148,163,184,0.3)" }}
              axisLine={false}
              tickLine={false}
      ...
      <div style={{ display: "flex", gap: "16px", marginTop: "8px", justifyContent: "center" }}>
        {[
          { label: "Ritmo ideal", color: "rgba(148,163,184,0.3)", dashed: true },
...
function PacingKPI({ label, value, subtext, color }: { label: string; value: string; subtext?: string; color?: string }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: "9px", color: "rgba(148,163,184,0.4)", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.08em" }}>
        {label}
      </div>
      ...
      {subtext && (
        <div style={{ fontSize: "9px", color: "rgba(148,163,184,0.35)", marginTop: "2px" }}>
          {subtext}
        </div>
      )}
    </div>
