...
export const Sheet: React.FC<SheetProps> = ({ isOpen, onClose, children, title, description, position = "right", className = "" }) => {
  ...
  return createPortal(
    <div className="fc-dialog-overlay" onClick={onClose}>
      <div className={`fc-sheet fc-sheet--${position}`} onClick={(e) => e.stopPropagation()}>
