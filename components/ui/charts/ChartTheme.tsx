  ...
  return (
    <defs>
      ...
      <linearGradient id="colorCyanArea" x1="0" y1="0" x2="0" y2="1">
        <stop offset="5%"  style={{ stopColor: "var(--cyan)" }} stopOpacity={0.30} />
        <stop offset="95%" style={{ stopColor: "var(--cyan)" }} stopOpacity={0} />
      </linearGradient>
      <linearGradient id="colorEmeraldArea" x1="0" y1="0" x2="0" y2="1">
        <stop offset="5%"  style={{ stopColor: "var(--emerald)" }} stopOpacity={0.28} />
        <stop offset="95%" style={{ stopColor: "var(--emerald)" }} stopOpacity={0} />
      </linearGradient>
      <linearGradient id="colorAmberArea" x1="0" y1="0" x2="0" y2="1">
        <stop offset="5%"  style={{ stopColor: "var(--amber)" }} stopOpacity={0.28} />
        <stop offset="95%" style={{ stopColor: "var(--amber)" }} stopOpacity={0} />
      </linearGradient>
      <linearGradient id="colorPurpleArea" x1="0" y1="0" x2="0" y2="1">
        <stop offset="5%"  style={{ stopColor: "var(--purple)" }} stopOpacity={0.28} />
        <stop offset="95%" style={{ stopColor: "var(--purple)" }} stopOpacity={0} />
      </linearGradient>
      <linearGradient id="colorRedArea" x1="0" y1="0" x2="0" y2="1">
        <stop offset="5%"  style={{ stopColor: "var(--red)" }} stopOpacity={0.28} />
        <stop offset="95%" style={{ stopColor: "var(--red)" }} stopOpacity={0} />
      </linearGradient>
      ...
      <linearGradient id="colorEmeraldBar" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%"   style={{ stopColor: "var(--emerald)" }} />
