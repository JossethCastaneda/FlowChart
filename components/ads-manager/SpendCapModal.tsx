        ...
        <div style={{ padding: "16px 20px" }}>
          ...
          <label style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "14px", cursor: "pointer" }}>
            <button
              ...
              style={{ background: "none", border: "none", cursor: "pointer", color: noLimit ? "var(--emerald)" : "var(--text-muted)" }}
            >
              {noLimit ? <ToggleRight className="w-6 h-6" /> : <ToggleLeft className="w-6 h-6" />}
            </button>
            <span style={{ fontSize: "11px", color: noLimit ? "var(--emerald)" : "var(--text-secondary)", fontWeight: 600 }}>
