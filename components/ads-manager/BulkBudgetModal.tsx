      ...
      <div style={{
        ...
        <div style={{ padding: "16px 20px" }}>
          ...
          <div style={{ marginBottom: "14px" }}>
            <label style={{ fontSize: "10px", color: "var(--text-muted)", fontWeight: 600, display: "block", marginBottom: "6px" }}>Tipo de presupuesto</label>
          ...
          {/* Preview table */}
          <div style={{ fontSize: "10px", color: "var(--text-muted)", fontWeight: 600, marginBottom: "6px" }}>Aplica a:</div>
          <div style={{ maxHeight: "180px", overflowY: "auto", borderRadius: "6px", border: "1px solid var(--hairline)" }} className="custom-scrollbar">
            {preview.map((p) => (
              <div key={p.id} style={{
                ...
                />
                <span style={{ fontSize: "10px", color: "var(--foreground)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{p.name}</span>
                <span style={{ fontSize: "10px", color: "var(--text-muted)" }}>${p.current.toFixed(2)}</span>
                <span style={{ fontSize: "10px", color: "var(--text-muted)" }}>?</span>
                <span style={{ fontSize: "10px", color: p.next > p.current ? "var(--emerald)" : p.next < p.current ? "var(--red)" : "white", fontWeight: 600 }}>
                  ${p.next.toFixed(2)}
                </span>
              </div>
            ))}
