      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: "1px solid var(--fc-border)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "13px", fontWeight: 700, color: "var(--fc-text)" }}>
            <Clipboard className="w-4 h-4" style={{ color: "var(--fc-accent)" }} />
            Elementos copiados
          </div>
        ...
        <div style={{ padding: "16px 20px", maxHeight: "300px", overflowY: "auto" }} className="custom-scrollbar">
          {items.length === 0 ? (
            <div style={{ textAlign: "center", padding: "40px 20px" }}>
              <Clipboard className="w-8 h-8" style={{ color: "var(--fc-text-muted)", margin: "0 auto 12px" }} />
              <div style={{ fontSize: "12px", color: "var(--fc-text-muted)", marginBottom: "4px" }}>
            ...
            <>
              {timestamp && (
                <div style={{ display: "flex", alignItems: "center", gap: "4px", fontSize: "9px", color: "var(--fc-text-muted)", marginBottom: "10px" }}>
              ...
              {items.map((item, i) => (
                <div key={item.id} style={{
                  ...
                  <span style={{ fontSize: "10px", color: "var(--fc-text-muted)", fontWeight: 600, width: "18px" }}>{i + 1}</span>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: "11px", color: "var(--fc-text)", fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {item.name}
                    </div>
                    <div style={{ fontSize: "9px", color: "var(--fc-text-muted)" }}>ID: {item.id}</div>
                  </div>
                </div>
              ))}
            </>
        ...
        <div style={{ display: "flex", gap: "8px", padding: "12px 20px", borderTop: "1px solid var(--fc-border)", justifyContent: "flex-end" }}>
          <button
            ...
            style={{
              ...
              background: "var(--fc-danger-wash)", border: "1px solid rgba(229,72,77,0.2)", borderRadius: "6px",
              color: items.length > 0 ? "var(--fc-danger)" : "rgba(148,163,184,0.65)", cursor: items.length > 0 ? "pointer" : "not-allowed",
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              color: items.length > 0 ? "var(--fc-accent)" : "rgba(148,163,184,0.65)",
