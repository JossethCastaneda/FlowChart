    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px", lineHeight: "1.7", fontSize: "15px" }}>
          <section>
            <p>
              En <strong>SODARE</strong> (sodare.xyz), la privacidad de nuestros usuarios es de suma importancia. Este Aviso de Privacidad detalla cómo recopilamos, utilizamos, protegemos y permitimos la eliminación de tus datos personales cuando utilizas nuestra plataforma y conectas tus cuentas a través de Meta/Facebook Login y la API de Meta.
            </p>
          </section>
          ...
          <section>
            ...
            <ul style={{ paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
              <li>Autenticar tu identidad y mantener la seguridad de tu cuenta en SODARE.</li>
