...
export default function ProjectError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
      <div className="w-full max-w-lg bg-[var(--fc-surface)] border border-[rgba(255,255,255,0.05)] rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-lg font-bold text-[var(--fc-text)] mb-2 tracking-wide">Error al cargar el proyecto</h2>
          <p className="text-[13px] text-[var(--fc-text-secondary)] mb-6 leading-relaxed">
          ...
          <div className="flex items-center gap-3 w-full">
            <Link 
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-[var(--surface-hover)] hover:bg-[var(--surface-hover)] text-[var(--fc-text)] py-2.5 rounded-lg text-sm font-medium transition-colors"
            >
