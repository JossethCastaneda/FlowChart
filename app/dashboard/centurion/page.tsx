...
import { validateMmmData } from "@/lib/mmm/validation";
...
export default function MediaMixPage() {
  ...
  const TABS: { key: Tab; label: string; icon: React.ElementType }[] = [
    { key: "datos", label: "1. Ingesta", icon: Database },
    { key: "config", label: "2. Mapeo", icon: Settings2 },
    { key: "modelo", label: "3. Diagnóstico", icon: Activity },
    { key: "resumen", label: "4. Resultados", icon: PieChartIcon },
