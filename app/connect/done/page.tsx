...
function ConnectDone() {
  ...
  return (
    <div style={{
      ...
      <div style={{ width: 32, height: 32, border: "3px solid #00d4ff", borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
      <p style={{ fontSize: 13, color: "#64748b" }}>Cerrando…</p>
