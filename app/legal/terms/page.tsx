...
export const metadata: Metadata = {
  ...
  description: "Términos y condiciones de uso de la plataforma FlowChart. Centro de mando de marketing multicanal para agencias y marcas.",
};

const LAST_UPDATED = "25 de junio de 2025";
const COMPANY = "FlowChart";
const CONTACT_EMAIL = "legal@flowchart.com";
const WEBSITE = "https://flowchart.com";
    ...
    <main style={{ maxWidth: 800, margin: "0 auto", padding: "60px 24px 80px" }}>
      ...
      <div style={{ marginBottom: 56 }}>
        ...
        <div style={{
          ...
          Al acceder y utilizar la plataforma FlowChart, usted acepta los presentes Términos de Servicio en su totalidad.
      ...
      <Section title="1. Definiciones">
        ...
        <Ul items={[
          "«Plataforma»: el software y servicios en línea proporcionados por FlowChart, incluyendo el dashboard de gestión, las integraciones con plataformas de terceros y todas las funcionalidades asociadas.",
          ...
          "«Servicio»: el conjunto de funcionalidades ofrecidas por FlowChart, incluidas gestión de campañas, análisis de conversaciones, automatización de marketing y publicación de contenido.",
        ]} />
      </Section>
      ...
      <Section title="3. Descripción del Servicio">
        <P>
          FlowChart es una plataforma SaaS de inteligencia de marketing multicanal que permite a agencias y marcas:
        </P>
        <Ul items={[
        ...
        <P>
          FlowChart se reserva el derecho de modificar, suspender o discontinuar cualquier funcionalidad de la Plataforma en cualquier momento, con o sin previo aviso.
        </P>
      </Section>
      ...
      <Section title="4. Registro y Cuentas">
        ...
        <Ul items={[
          ...
          "Notificar inmediatamente a FlowChart cualquier uso no autorizado de su cuenta.",
          "No compartir su cuenta con terceros no autorizados.",
        ]} />
        <P>
          FlowChart se reserva el derecho de suspender o cancelar cuentas que violen estos términos o que se utilicen de manera fraudulenta.
        </P>
      </Section>
      ...
      <Section title="5. Uso Aceptable">
        ...
        <Ul items={[
          ...
          "Revender, sublicenciar o transferir el acceso a la Plataforma sin autorización expresa de FlowChart.",
        ]} />
      </Section>

      <Section title="6. Integraciones con Plataformas de Terceros">
        <P>
          FlowChart se integra con plataformas de terceros como Meta (Facebook, Instagram), TikTok, WhatsApp Business, Google Ads y otras. Al conectar estas integraciones:
        </P>
        <Ul items={[
          "El Usuario autoriza a FlowChart a acceder y gestionar los datos y funcionalidades de dichas plataformas en su nombre.",
          "El Usuario declara que cumple con los Términos de Servicio y Políticas de uso de cada plataforma de terceros.",
          "FlowChart no es responsable de cambios, interrupciones o decisiones en las APIs de plataformas de terceros.",
      ...
      <Section title="7. Propiedad Intelectual">
        <P>
          <strong style={{ color: "var(--fc-text)" }}>Propiedad de FlowChart:</strong> La Plataforma, incluyendo su código fuente, diseño, logotipos, marcas, interfaces y documentación, son propiedad exclusiva de FlowChart y están protegidos por las leyes de propiedad intelectual aplicables.
        </P>
        <P>
          <strong style={{ color: "var(--fc-text)" }}>Licencia de uso:</strong> FlowChart otorga al Usuario una licencia limitada, no exclusiva, no transferible y revocable para utilizar la Plataforma de conformidad con estos Términos.
        </P>
        <P>
          <strong style={{ color: "var(--fc-text)" }}>Contenido del Usuario:</strong> El Usuario retiene todos los derechos sobre el contenido que publique o cargue en la Plataforma. Al utilizarla, el Usuario otorga a FlowChart una licencia para procesar, almacenar y transmitir dicho contenido en la medida necesaria para prestar el servicio.
        </P>
      </Section>
      ...
      <Section title="8. Privacidad y Protección de Datos">
        ...
        <P>
          FlowChart implementa medidas de seguridad técnicas y organizativas apropiadas para proteger los datos contra accesos no autorizados, pérdida o divulgación indebida.
        </P>
      </Section>
      ...
      <Section title="9. Pagos y Facturación">
        ...
        <Ul items={[
          ...
          "FlowChart se reserva el derecho de modificar sus precios con previo aviso de 30 días.",
        ]} />
      </Section>
      ...
      <Section title="10. Limitación de Responsabilidad">
        ...
        <Ul items={[
          "FlowChart no garantiza que la Plataforma esté libre de errores, interrupciones o vulnerabilidades.",
          "FlowChart no será responsable por daños indirectos, incidentales, especiales o consecuentes.",
          "La responsabilidad total de FlowChart no excederá los importes pagados por el Usuario en los últimos 3 meses.",
          "FlowChart no es responsable de pérdidas derivadas de interrupciones en plataformas de terceros integradas.",
        ]} />
      </Section>

      <Section title="11. Modificaciones de los Términos">
        <P>
          FlowChart se reserva el derecho de modificar estos Términos de Servicio en cualquier momento. Los cambios materiales serán notificados con al menos 15 días de anticipación a través de la Plataforma o por correo electrónico. El uso continuado de la Plataforma tras la notificación implica la aceptación de los nuevos términos.
        </P>
      </Section>

      <Section title="12. Terminación">
        <P>
          Cualquiera de las partes puede terminar la relación en cualquier momento. FlowChart puede suspender o cancelar el acceso del Usuario de forma inmediata si:
        </P>
        <Ul items={[
        ...
        <P>
          Tras la terminación, FlowChart podrá eliminar los datos del Usuario de acuerdo con su política de retención de datos, salvo que la ley exija su conservación.
        </P>
      </Section>

      <Section title="13. Ley Aplicable y Jurisdicción">
        <P>
          Estos Términos de Servicio se rigen por las leyes aplicables en el territorio donde opere FlowChart. Cualquier disputa que no pueda resolverse amigablemente será sometida a la jurisdicción de los tribunales competentes del domicilio de FlowChart, renunciando expresamente las partes a cualquier otro fuero.
        </P>
      </Section>
      ...
      <Section title="14. Contacto">
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 4px", color: "var(--fc-text)", fontWeight: 600 }}>{COMPANY}</p>
