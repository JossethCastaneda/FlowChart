...
export const metadata: Metadata = {
  title: "Política de Privacidad — FlowChart",
  description: "Política de privacidad y protección de datos de la plataforma FlowChart. Conoce cómo recopilamos, usamos y protegemos tu información.",
};

const LAST_UPDATED = "25 de junio de 2025";
const COMPANY = "FlowChart";
const CONTACT_EMAIL = "privacy@flowchart.com";
  ...
  return (
    <main style={{ maxWidth: 800, margin: "0 auto", padding: "60px 24px 80px" }}>
      ...
      <Section title="5. Integraciones y Plataformas de Terceros">
        <P>
          FlowChart actúa como procesador de datos en nombre del Usuario cuando gestiona datos a través de las siguientes integraciones:
        </P>
        <Ul items={[
        ...
        <P>
          El uso de datos obtenidos de estas plataformas se rige por las políticas de privacidad de cada una de ellas y por los permisos que el Usuario otorgue expresamente. FlowChart no vende ni comparte estos datos con terceros no autorizados.
        </P>
      </Section>

      <Section title="6. Compartición de Datos con Terceros">
        <P>
          FlowChart puede compartir tus datos con terceros únicamente en los siguientes casos:
        </P>
        <Ul items={[
          ...
          "Protección de derechos: cuando sea necesario para proteger los derechos, seguridad o propiedad de FlowChart o sus usuarios.",
      ...
      <Section title="7. Transferencias Internacionales de Datos">
        <P>
          FlowChart puede transferir datos a proveedores situados fuera de tu país de residencia. Cuando realizamos transferencias internacionales, implementamos las salvaguardas adecuadas, tales como:
        </P>
        <Ul items={[
