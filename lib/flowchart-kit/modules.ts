/* ════════════════════════════════════════════════════════════
   ...
   Modelo de DOS CAPAS:
     ...
     · code  → el codename / esencia (color, ícono, lema, voz del asistente)
   Importa este archivo en el sidebar, breadcrumbs, headers y loaders.
   ════════════════════════════════════════════════════════════ */
...
export const MODULES: ModuleDef[] = [
  ...
  { key: "resumen",     label: "Resumen",  code: "Pulso",    route: "/dashboard/resumen",  color: "var(--fc-module-resumen)",  icon: "activity",        tagline: "El latido de tu operación",   group: "operacion" },
  { key: "clientes",    label: "Clientes", code: "Cartera",  route: "/dashboard/proyectos", color: "var(--fc-module-clientes)", icon: "folder-kanban",  tagline: "Tus cuentas, en órbita",      group: "operacion",
    tabs: [
      { label: "Resumen",                route: "" },
      { label: "Configuración",          route: "/configuracion" },
    ] },
  { key: "inbox",       label: "Inbox",    code: "Señal",    route: "/dashboard/inbox",    color: "var(--fc-module-inbox)",    icon: "messages-square", tagline: "Cada mensaje, un solo canal", group: "operacion" },
  ...
  { key: "integraciones", label: "Integraciones", code: "Enlaces", route: "/dashboard/integrations", color: "var(--fc-text-muted)", icon: "plug", tagline: "Conecta tus cuentas", group: "sistema",
    tabs: [
      { label: "Facebook", route: "/facebook" },
      { label: "Meta Ads", route: "/meta-ads" },
      { label: "WhatsApp", route: "/whatsapp" },
    ] },
  { key: "configuracion", label: "Configuración", code: "Consola", route: "/dashboard/settings", color: "var(--fc-text-muted)", icon: "settings", tagline: "Tu cuenta y tu workspace", group: "sistema" },
];
...
export const FUTURE_MODULES: FutureModuleDef[] = [
  ...
  // FlowChart Copilot+ NO es un módulo: es una capa transversal. Ver assistant-states.md.

  // ── Fase 3 · gobernanza & escala (exploratoria) ──
  { key: "roles",  label: "Roles & permisos",   code: "Mando",   route: "/dashboard/settings/roles", color: "var(--fc-text-muted)", icon: "shield",  tagline: "Acceso por rol y por cliente", group: "sistema", status: "planned", phase: 3, tabOf: "configuracion" },
  { key: "api",    label: "API & automatización", code: "Puente", route: "/dashboard/settings/api",  color: "var(--fc-text-muted)", icon: "webhook", tagline: "Webhooks y conectores externos", group: "sistema", status: "planned", phase: 3, tabOf: "configuracion" },
];
