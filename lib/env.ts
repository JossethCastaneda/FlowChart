...
const envSchema = z.object({
  ...
  META_APP_ID: z.string().min(1).optional().default(process.env.FACEBOOK_CLIENT_ID || ""),
  META_APP_SECRET: z.string().min(1).optional().default(process.env.FACEBOOK_CLIENT_SECRET || ""),
